...
{
    private static List<string> _manifest = new()
    {
    ...
    private static List<string> _clientFile = new()
    {
    ...
    private static void GenerateClientFile(ObservableCollection<Audio> AudioFiles, string soundSetName)
    {
    ...
    public static void GenerateManifest(string outputPath, ObservableCollection<Audio> AudioFiles, bool debugFiles, string SoundSetName)
    {
